...
public class MZConciliaMedioPago extends X_Z_ConciliaMedioPago implements DocAction, DocOptions {
    ...
    public MZConciliaMedioPago (Properties ctx, int Z_ConciliaMedioPago_ID, String trxName)
    {
      super (ctx, Z_ConciliaMedioPago_ID, trxName);
    }

    /** Load Constructor */
    public MZConciliaMedioPago (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("MZConciliaMedioPago[")
