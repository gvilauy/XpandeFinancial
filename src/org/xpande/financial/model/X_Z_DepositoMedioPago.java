...
public class X_Z_DepositoMedioPago extends PO implements I_Z_DepositoMedioPago, I_Persistent 
{
    ...
    public X_Z_DepositoMedioPago (Properties ctx, int Z_DepositoMedioPago_ID, String trxName)
    {
      super (ctx, Z_DepositoMedioPago_ID, trxName);
      /** if (Z_DepositoMedioPago_ID == 0)
        {
...
// N
    ...
    /** Load Constructor */
    public X_Z_DepositoMedioPago (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_DepositoMedioPago[")
	...
	public void setZ_DepositoMedioPago_ID (int Z_DepositoMedioPago_ID)
	{
		if (Z_DepositoMedioPago_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_DepositoMedioPago_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_DepositoMedioPago_ID, Integer.valueOf(Z_DepositoMedioPago_ID));
	}
