...
public class X_Z_MovCaja extends PO implements I_Z_MovCaja, I_Persistent 
{
    ...
    public X_Z_MovCaja (Properties ctx, int Z_MovCaja_ID, String trxName)
    {
...
// N
    ...
    /** Load Constructor */
    public X_Z_MovCaja (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_MovCaja[")
	...
	{
		if (Z_MovCaja_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_MovCaja_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_MovCaja_ID, Integer.valueOf(Z_MovCaja_ID));
	}
