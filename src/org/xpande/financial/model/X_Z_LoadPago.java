...
// N
    ...
    /** Load Constructor */
    public X_Z_LoadPago (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_LoadPago[")
	...
	{
		if (Z_LoadPago_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_LoadPago_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_LoadPago_ID, Integer.valueOf(Z_LoadPago_ID));
	}
