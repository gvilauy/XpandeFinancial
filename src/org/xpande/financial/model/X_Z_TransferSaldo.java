...
public class X_Z_TransferSaldo extends PO implements I_Z_TransferSaldo, I_Persistent 
{
...
// N
    ...
    /** Load Constructor */
    public X_Z_TransferSaldo (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_TransferSaldo[")
	...
	public void setZ_TransferSaldo_ID (int Z_TransferSaldo_ID)
	{
		if (Z_TransferSaldo_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_TransferSaldo_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_TransferSaldo_ID, Integer.valueOf(Z_TransferSaldo_ID));
	}
