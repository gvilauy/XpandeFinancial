...
/** Generated Model for Z_PagoAfectacion
 *  @author Adempiere (generated) 
 *  @version Release 3.9.0 - $Id$ */
public class X_Z_PagoAfectacion extends PO implements I_Z_PagoAfectacion, I_Persistent 
{
    ...
    public X_Z_PagoAfectacion (Properties ctx, int Z_PagoAfectacion_ID, String trxName)
    {
      super (ctx, Z_PagoAfectacion_ID, trxName);
      /** if (Z_PagoAfectacion_ID == 0)
        {
			setAD_Table_ID (0);
			...
			setRecord_ID (0);
			setZ_PagoAfectacion_ID (0);
			setZ_Pago_ID (0);
        } */
    }

    /** Load Constructor */
    public X_Z_PagoAfectacion (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_PagoAfectacion[")
	...
	/** Set Z_PagoAfectacion ID.
		@param Z_PagoAfectacion_ID Z_PagoAfectacion ID	  */
	public void setZ_PagoAfectacion_ID (int Z_PagoAfectacion_ID)
	{
		if (Z_PagoAfectacion_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_PagoAfectacion_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_PagoAfectacion_ID, Integer.valueOf(Z_PagoAfectacion_ID));
	}

	/** Get Z_PagoAfectacion ID.
		@return Z_PagoAfectacion ID	  */
	public int getZ_PagoAfectacion_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Z_PagoAfectacion_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
