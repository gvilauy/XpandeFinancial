...
public class X_Z_ConciliaMedioPago extends PO implements I_Z_ConciliaMedioPago, I_Persistent 
{
    ...
    public X_Z_ConciliaMedioPago (Properties ctx, int Z_ConciliaMedioPago_ID, String trxName)
    {
      super (ctx, Z_ConciliaMedioPago_ID, trxName);
      /** if (Z_ConciliaMedioPago_ID == 0)
        {
...
// N
    ...
    /** Load Constructor */
    public X_Z_ConciliaMedioPago (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_ConciliaMedioPago[")
	...
	public void setZ_ConciliaMedioPago_ID (int Z_ConciliaMedioPago_ID)
	{
		if (Z_ConciliaMedioPago_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_ConciliaMedioPago_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_ConciliaMedioPago_ID, Integer.valueOf(Z_ConciliaMedioPago_ID));
	}
