...
/** Generated Model for Z_LoadMedioPagoFile
 *  @author Adempiere (generated) 
 *  @version Release 3.9.0 - $Id$ */
public class X_Z_LoadMedioPagoFile extends PO implements I_Z_LoadMedioPagoFile, I_Persistent 
{
    ...
    public X_Z_LoadMedioPagoFile (Properties ctx, int Z_LoadMedioPagoFile_ID, String trxName)
    {
      super (ctx, Z_LoadMedioPagoFile_ID, trxName);
      /** if (Z_LoadMedioPagoFile_ID == 0)
        {
...
// N
			setProcessed (false);
// N
			setZ_LoadMedioPagoFile_ID (0);
        } */
    }

    /** Load Constructor */
    public X_Z_LoadMedioPagoFile (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_LoadMedioPagoFile[")
	...
	/** Set Z_LoadMedioPagoFile ID.
		@param Z_LoadMedioPagoFile_ID Z_LoadMedioPagoFile ID	  */
	public void setZ_LoadMedioPagoFile_ID (int Z_LoadMedioPagoFile_ID)
	{
		if (Z_LoadMedioPagoFile_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_LoadMedioPagoFile_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_LoadMedioPagoFile_ID, Integer.valueOf(Z_LoadMedioPagoFile_ID));
	}

	/** Get Z_LoadMedioPagoFile ID.
		@return Z_LoadMedioPagoFile ID	  */
	public int getZ_LoadMedioPagoFile_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Z_LoadMedioPagoFile_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
