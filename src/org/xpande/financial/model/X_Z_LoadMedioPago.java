...
public class X_Z_LoadMedioPago extends PO implements I_Z_LoadMedioPago, I_Persistent 
{
    ...
    public X_Z_LoadMedioPago (Properties ctx, int Z_LoadMedioPago_ID, String trxName)
    {
      super (ctx, Z_LoadMedioPago_ID, trxName);
      /** if (Z_LoadMedioPago_ID == 0)
        {
			setC_DocType_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_Z_LoadMedioPago (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_LoadMedioPago[")
	...
	public void setZ_LoadMedioPago_ID (int Z_LoadMedioPago_ID)
	{
		if (Z_LoadMedioPago_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_LoadMedioPago_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_LoadMedioPago_ID, Integer.valueOf(Z_LoadMedioPago_ID));
	}
