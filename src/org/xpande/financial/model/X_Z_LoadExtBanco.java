...
public class X_Z_LoadExtBanco extends PO implements I_Z_LoadExtBanco, I_Persistent 
{
    ...
    public X_Z_LoadExtBanco (Properties ctx, int Z_LoadExtBanco_ID, String trxName)
    {
      super (ctx, Z_LoadExtBanco_ID, trxName);
      /** if (Z_LoadExtBanco_ID == 0)
        {
...
// N
    ...
    /** Load Constructor */
    public X_Z_LoadExtBanco (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_LoadExtBanco[")
	...
	public void setZ_LoadExtBanco_ID (int Z_LoadExtBanco_ID)
	{
		if (Z_LoadExtBanco_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_LoadExtBanco_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_LoadExtBanco_ID, Integer.valueOf(Z_LoadExtBanco_ID));
	}
