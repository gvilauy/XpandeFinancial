...
public class X_Z_MedioPagoReplace extends PO implements I_Z_MedioPagoReplace, I_Persistent 
{
...
// N
    ...
    /** Load Constructor */
    public X_Z_MedioPagoReplace (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_MedioPagoReplace[")
	...
	{
		set_Value (COLUMNNAME_AmtFrom, AmtFrom);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_AmtFrom);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	{
		set_Value (COLUMNNAME_AmtTo, AmtTo);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_AmtTo);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
    ...
    {
		return (I_Z_MedioPagoMotivoRep)MTable.get(getCtx(), I_Z_MedioPagoMotivoRep.Table_Name)
			.getPO(getZ_MedioPagoMotivoRep_ID(), get_TrxName());	}
	...
	public void setZ_MedioPagoMotivoRep_ID (int Z_MedioPagoMotivoRep_ID)
	{
		if (Z_MedioPagoMotivoRep_ID < 1) 
			set_Value (COLUMNNAME_Z_MedioPagoMotivoRep_ID, null);
		else 
			set_Value (COLUMNNAME_Z_MedioPagoMotivoRep_ID, Integer.valueOf(Z_MedioPagoMotivoRep_ID));
	}
	...
	public void setZ_MedioPagoReplace_ID (int Z_MedioPagoReplace_ID)
	{
		if (Z_MedioPagoReplace_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_MedioPagoReplace_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_MedioPagoReplace_ID, Integer.valueOf(Z_MedioPagoReplace_ID));
	}
